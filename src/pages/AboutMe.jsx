...
export function AboutMe() {
    return (
        <Container>
            ...
            <p>В университете углубился в изучение программирования, сначала jQuery для фронта и PHP для бэка, SQL я тоже знаю, но чаще всего использовал ORM, ReadBeans для PHP. <a href="https://www.новая-иберия.рф/main.php" target="_blank">[проект]</a></p>
            <p>Я также работал на python, но больше для решения учебных задач. Из веба попробовал Django. <a href="https://stroy-penoplast.ru/shop/penopolistirol" target="_blank">[проект]</a></p>
            ...
            <ul>
                <li><a href="https://george-avsa.github.io/fm-dictionary/">Переводчик</a> - проект-челендж с платформы frontendmentor. Тут я использовал React, Redux и Thunk в качестве middleware для ассинхронных запросов.</li>
                <li><a href="https://github.com/george-avsa/fm-invoice-app">Приложение для остлеживания счетов</a> - также проект-челендж с платформы frontendmentor. Сейчас проект находится в разработке.</li>
            </ul>
        </Container>
    );
}